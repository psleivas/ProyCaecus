...
module.exports = (sequelize, DataTypes) => {
  ...
  class DescripcionCorreoElectronico extends Model {
      /**
  ...
  DescripcionCorreoElectronico.init({
    ...
    sequelize,
    modelName: 'DescripcionCorreoElectronico',
  });

  return DescripcionCorreoElectronico;
};