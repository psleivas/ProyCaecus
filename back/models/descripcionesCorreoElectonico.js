...
module.exports = (sequelize, DataTypes) => {
  ...
  class DescripcionesCorreoElectronico extends Model {
      /**
  ...
  DescripcionesCorreoElectronico.init({
    ...
    sequelize,
    modelName: 'DescripcionesCorreoElectronico',
  });

  return DescripcionesCorreoElectronico;
};